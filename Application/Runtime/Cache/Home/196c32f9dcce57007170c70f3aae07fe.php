...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
            ...
            <link href="/MyBoxService/Public/Styles/wows_show.css" rel="stylesheet">
 ...
 $cid=I('get.category'); foreach($cate as $value) { if($cid==$value['id']) $flag="class='selected'"; ?>
                                            <li <?php echo $flag ?>><a href="/MyBoxService/index.php/Home/Ser/wows_showing?category=<?php echo $value['id'] ?>" target="_self"><?php echo $value['name'] ?></a></li>
                                            <?php
 $flag=""; } ?>
                                   </ul>
                                </div>
