<?php if (!defined('THINK_PATH')) exit();?>    <!-- $Id: brand_info.htm 14216 2008-03-10 02:27:21Z testyang $ -->
    ...
    <div class="main-div">
        <!-- /MyBoxService/index.php/Home/Plugin/add:当前方法 -->
        <form method="POST" action="/MyBoxService/index.php/Home/Plugin/add" enctype="multipart/form-data">
            <table cellspacing="1" cellpadding="3" width="100%">
                <tr>
                    <td class="label">游戏种类：</td>
                    <td>
                        <select name="gid" style="width: 145px;">
                            <?php  $cid=I('get.gid'); foreach($gamelist as $key=>$value){ if($cid==$key) $flag="SELECTED"; ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span class="require-field">* jpg文件</span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <span class="require-field">* zip文件</span>
                    </td>
                </tr>
                <tr>
                    <td class="label">兼容性：</td>
                    <td>
                        <INPUT type="checkbox" name="support[]" value="多玩盒子" checked/> 多玩盒子
                        <INPUT type="checkbox" name="support[]" value="XVM" checked/> XVM
                        <span class="require-field">*</span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" name="edition" maxlength="60" value="" />
                        <span class="require-field">*</span>
                    </td>
                </tr>
                <tr>
