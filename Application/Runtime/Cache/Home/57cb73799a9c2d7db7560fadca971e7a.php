                            ...
                            <div class="wrap box_bg index_wrap">
                                <div class="box_top_nav">
                                   <ul>
                                        ...
                                        <?php
 $cid=I('get.category'); foreach($cate as $value) { if($value['id']==5||$value['name']=="黑科技") continue; if($cid==$value['id']) $flag="class='selected'"; ?>
                                                <li <?php echo $flag ?>><a href="/MyBoxService/index.php/Home/Ser/publicShowWows?category=<?php echo $value['id'] ?>" target="_self"><?php echo $value['name'] ?></a></li>
                                                <?php
 $flag=""; } ?>
                                   </ul>
                                </div>
