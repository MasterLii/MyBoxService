...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <style type="text/css">
            ...
            .explode {
                background:url(/MyBoxService/Public/Images/menu_minus.gif) no-repeat 0px 3px;
                font-weight:bold;
            }
            .collapse {
                background:url(/MyBoxService/Public/Images/menu_plus.gif) no-repeat 0px 3px;
                font-weight:bold;
            }
            .menu-item {
                background:url(/MyBoxService/Public/Images/menu_arrow.gif) no-repeat 0px 3px;
                font-weight:normal;
            }
            #help-title {
                font-size:14px;
    ...
    <body>
            ...
            <p>
                <span style="float:right; padding:3px 5px;" >
                    <a href="javascript:toggleCollapse();">
                        <img id="toggleImg" src="/MyBoxService/Public/Images/menu_minus.gif" width="9" height="9" border="0" alt="闭合" />
                    </a>
                </span>
        ...
        <div id="main-div">
            <div id="menu-list">
                <ul id="menu-ul">
                    <li class="explode" name="主页">

                        <a href="/MyBoxService/index.php/Home/Index/main" target="main-frame">主页</a>
                    </li>
                    <?php if ($action==1):?>
                    <!--管理员菜单-->
                    <li class="explode" name="menu">
                        ...
                        插件管理
                        <ul>
                            <li class="menu-item"><a href="/MyBoxService/index.php/Home/Plugin/lst" target="main-frame">插件列表</a></li>
                            <li class="menu-item"><a href="/MyBoxService/index.php/Home/Plugin/add" target="main-frame">添加插件</a></li>
                        </ul>
                    </li>
                    <li class="explode" name="menu">
                        ...
                        代理商管理
                        <ul>
                            <li class="menu-item"><a href="/MyBoxService/index.php/Home/Admin/lst" target="main-frame">代理商列表</a></li>
                            <li class="menu-item"><a href="/MyBoxService/index.php/Home/Admin/add" target="main-frame">添加代理商</a></li>
                    ...
                    <li class="explode" key="08_members" name="menu">
                        用户管理
                        <ul>
                            <li class="menu-item"><a href="/MyBoxService/index.php/Home/User/lst" target="main-frame">用户列表</a></li>
                            <li class="menu-item"><a href="/MyBoxService/index.php/Home/User/add" target="main-frame">添加用户</a></li>
                        </ul>
                    </li>
                   <li class="explode" key="08_members" name="menu">
                        广告编辑
                        <ul>
                            <li class="menu-item"><a href="/MyBoxService/index.php/Home/Ad/wotad" target="main-frame">坦克世界广告</a></li>
                            <li class="menu-item"><a href="/MyBoxService/index.php/Home/Ad/wowsad" target="main-frame">战舰世界广告</a></li>
                        </ul>
                    </li>
                    <li class="explode"  name="menu">
                        插件分类管理
                        <ul>
                            <li class="menu-item"><a href="/MyBoxService/index.php/Home/Category/lst" target="main-frame">分类列表</a></li>
                            <li class="menu-item"><a href="/MyBoxService/index.php/Home/Category/add" target="main-frame">添加分类</a></li>
                        </ul>
                    </li>
                    <!--代理商菜单-->
                    <?php endif ?>
                    <li class="explode"  name="menu">
                        充值卡管理
                        <ul>
                            <li class="menu-item"><a href="/MyBoxService/index.php/Home/Card/lst" target="main-frame">充值卡浏览</a></li>
                            <li class="menu-item"><a href="/MyBoxService/index.php/Home/Card/add" target="main-frame">充值卡制作</a></li>
        ...
        <script type="text/javascript" src="/MyBoxService/Public/Js/global.js"></script>
        <script type="text/javascript" src="/MyBoxService/Public/Js/utils.js"></script>
        <script type="text/javascript" src="/MyBoxService/Public/Js/transport.js"></script>
        <script language="JavaScript">
            ...
            function toggleCollapse() {
                ...
                collapse = !collapse;
                document.getElementById('toggleImg').src = collapse ? '/MyBoxService/Public/Images/menu_minus.gif' : '/MyBoxService/Public/Images/menu_plus.gif';
