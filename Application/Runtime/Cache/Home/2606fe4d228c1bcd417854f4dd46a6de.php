...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
            ...
            <link href="/BoxService/Public/Styles/show.css" rel="stylesheet">
 ...
 $cid=I('get.category'); foreach($cate as $value) { if($cid==$value['id']) $flag="class='selected'"; ?>
                                            <li <?php echo $flag ?>><a href="/BoxService/index.php/Home/Ser/show?category=<?php echo $value['id'] ?>" target="_self"><?php echo $value['name'] ?></a></li>
                                            <?php
 $flag=""; } ?>
                                   </ul>
                                </div>
 ...
 foreach($data as $value) {?>
                                      <li>
                                          <a class="paint_pic"><img src="/BoxService/PlugImage/<?php echo $value['guid'] ?>.jpg" style="height:90px;width:120px;border:solid 2px white;"></a>
                                            <div class="btn-bar">
