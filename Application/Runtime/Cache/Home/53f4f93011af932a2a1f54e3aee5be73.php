...
<body>
<h1>
    <span class="action-span"><a href="/BoxService/index.php/Home/Category/lst">列表</a></span>
    <span class="action-span1"><a href="#">ECSHOP 管理中心</a></span>
    <span id="search_id" class="action-span1"> - 修改 </span>
    <div style="clear:both"></div>
</h1>
<div class="main-div">
<!-- /BoxService/index.php/Home/Category/edit/id/4:当前方法 -->
    <form method="POST" action="/BoxService/index.php/Home/Category/edit/id/4">
