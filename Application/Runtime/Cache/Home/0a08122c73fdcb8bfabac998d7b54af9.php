...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
            ...
            <link href="/BoxService/Public/Styles/wowp_show.css" rel="stylesheet">
 ...
 $cid=I('get.category'); foreach($cate as $value) { if($cid==$value['id']) $flag="class='selected'"; ?>
                                            <li <?php echo $flag ?>><a href="/BoxService/index.php/Home/Ser/wowp_show?category=<?php echo $value['id'] ?>" target="_self"><?php echo $value['name'] ?></a></li>
                                            <?php
 $flag=""; } ?>
                                   </ul>
                                </div>
