...
<div id="header-div">
    ...
    <div id="submenu-div">
        <ul>
            <li><a href="/MyBoxService/index.php/home/index/main" target="main-frame">主页</a></li>
            <li><a href="/MyBoxService/index.php/home/index/changepwd" target="main-frame" target="main-frame">修改密码</a></li>
            <li style="border-right:none"><a href="#">刷新</a></li>
        </ul>
        <div id="send_info">
            <a href="/MyBoxService/index.php/Home/Login/logout" target="_top" class="fix-submenu">退出</a>
        </div>
    </div>
</div>
<div id="menu-div">
